...
for (let character of starWarsCharacters) {
  switch (character.eye_color) {
    ...
    case "blue-gray":
      ...
      break;
    default:
      console.log("Character lost his eyes probably");
  }
}
...
let lenght = starWarsCharacters.length;
let crewMass = 0;
let i = 0;
...
for (let character of charactersNames) {
  if (character in femaleCharacters) {
    delete character;
  }
}
...
function characterSpeak(character) {
  return `My name is ${character.name}, I'm ${character.height} tall and I've got ${character.eyeColor} eyes`;
}

console.log(characterSpeak(starWarsCharacters[0]));
